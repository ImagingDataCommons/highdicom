...
See :class:`highdicom.sr.ObserverContext`,
:class:`highdicom.sr.ObservationContext`,
:class:`highdicom.sr.PersonObserverIdentifyingAttributes`, and
:class:`highdicom.sr.DeviceObserverIdentifyingAttributes` for more details on
these classes and a full list of optional parameters.
...
- ``measurements``: (Sequence of :class:`highdicom.sr.Measurement`, optional)
  Numeric measurements, see below.
- ``qualitative_evaluations``: (Sequence of
  :class:`highdicom.sr.QualitativeEvaluation`, optional) Coded name-value pairs
  that describe qualitative evaluations, see below.
